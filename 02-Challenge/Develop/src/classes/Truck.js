...
var Vehicle_1 = require("./Vehicle"); // Correct import for Vehicle class
var Truck = /** @class */ (function (_super) {
    __extends(Truck, _super);
    function Truck(vin, color, make, model, year, weight, topSpeed, wheels, towingCapacity) {
        var _this = _super.call(this, vin, color, make, model, year, weight, topSpeed) || this; // Call parent constructor
        _this.wheels = wheels;
    ...
    Truck.prototype.getDetails = function () {
        return "".concat(_super.prototype.getDetails.call(this), " - Towing Capacity: ").concat(this.towingCapacity, " lbs");
    };
    return Truck;
}(Vehicle_1.default));
